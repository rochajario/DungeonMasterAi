  ...
  >
    <q-step :name="1" title="Welcome" icon="settings" :done="step > 1">
      <q-card
        ...
        bordered
        style="
          background: radial-gradient(circle, #ecd9b2 0%, #d3ba88 100%);
          width: 100%;
          height: 100%s;
        "
      >
        ...
        <q-card-section horizontal>
          ...
          >
            <p class="text-bold text-primary">
              Greetings and welcome, adventurer.
            </p>
            <p class="text-secondary">
              {{
                `Here, magic and mystery abound, and great tales await those
            ...
            <p class="text-bold text-primary">
              To start a new campaign you shall define your caracter's traits
              and skills.
            </p>
          </q-card-section>
        </q-card-section>
          ...
          >
            <div class="q-pa-md column justify-center q-gutter-md">
              <q-input
                ...
                hint="Place your character's name"
                lazy-rules
                :rules="[
              ...
              <q-select
                ...
                :options="raceOptions"
                label="Race"
                hint="Place your character's race"
                :rules="[(val) => !val || 'Please select a race']"
              />
              <q-select
                dense
                outlined
                ...
                label="Gender"
                hint="Place your character's gender"
                :rules="[(val) => !val || 'Please select a gender']"
              />
              <q-input
                type="textarea"
                v-model="backgroundStory"
                dense
                outlined
                label="Backgound History"
                hint="Place your character's background story"
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Please type something',
                ]"
          ...
          >
            <div class="q-pa-md column justify-center q-gutter-md">
              <q-input
                ...
                outlined
                label="Strength"
                hint="Place your character's Strength points"
                :rules="[
                  (val) =>
                    (val && !(val <= 0 || val > 20)) ||
                    'Skill points must be in between 1 and 20',
                ]"
              />
              <q-input
                type="number"
                ...
                outlined
                label="Dexterity"
                hint="Place your character's Dexterity points"
                :rules="[
                  (val) =>
                    (val && !(val <= 0 || val > 20)) ||
                    'Skill points must be in between 1 and 20',
              ...
              <q-input
                ...
                outlined
                label="Intelligence"
                hint="Place your character's Intelligence points"
                :rules="[
                  (val) =>
                    (val && !(val <= 0 || val > 20)) ||
                    'Skill points must be in between 1 and 20',
              ...
              <q-input
                ...
                outlined
                label="Wisdom"
                hint="Place your character's Wisdom points"
                :rules="[
                  (val) =>
                    (val && !(val <= 0 || val > 20)) ||
                    'Skill points must be in between 1 and 20',
              ...
              <q-input
                ...
                outlined
                label="Charisma"
                hint="Place your character's Charisma points"
                :rules="[
                  (val) =>
                    (val && !(val <= 0 || val > 20)) ||
                    'Skill points must be in between 1 and 20',
...
export default defineComponent({
  ...
  data() {
    return {
      message:
        "To start a new adventure you shall define your character traits and skills.",
      step: 1,
      raceOptions: [
        "Dwarf",
        "Elf",
